...
<title>ORACLE DATABASE 11g - OCP EXAM_RANDOMrgb(0,51,0) </title>
<style type="text/css">
	div {
		width:85%;
	...
	.style2 {font-size:2.5em;!position:absolute;bottom:5%;color:white;height:5%;background-color:rgb(0,51,0); !margin:40px;text-align:right;}
	.style3 {font-size:2.5em;position:absolute;bottom:0px;right:0px;display:none}
	

</style>
<script type="text/javascript">
	var answer_toggle=true; // 문제부분이 화면이 보이는지 여부
	function answer() {
