...
<style type="text/css">
	...
	.style2 {font-size:2.5em;color:rgb(240,240,240);background-color:rgb(230,230,230);} 
...
<td class="style2" align="left" width="1%" style="word-break:break-all"> <%=rp.getAnswer().get(i)%>
</td> 
</tr>
<tr><td class="style3" colspan="2"></td><td></td></tr>
<% } %>
